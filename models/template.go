...
func readTemplate(templates []string, templateDir string) ([]TemplateBlog, error) {
	...
	for _, val := range templates {
		...
		t, err := t.ParseFiles(templateDir+viewName, home, footer, header, pagination, personal, post)
		if err != nil {
